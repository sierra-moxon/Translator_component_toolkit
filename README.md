...
TCT can be installed from PyPI: `pip install TCT`

You can also clone the repository from github, and then run `pip install -e .` from the repository's root folder.
